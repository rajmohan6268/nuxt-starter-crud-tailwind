    ...
    <div class="flex flex-wrap -mx-4 -mb-4 md:mb-0">
      ...
      <div class="w-full md:w-1/2 px-4 mb-4 md:mb-0">
        ...
        >
          <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <div v-if="!submitted">
              <div class="mb-4">
                <span class="font-bold text-2xl text-gray-600">Add new post</span>
                <label
      ...
      <div class="row-md-6">
        ...
        <div class="bg-blue-800 p-2 shadow text-xl text-white">
          <span class="relative w-full pb-2">
            <input
              v-model="title"
              type="text"
        ...
        <div>
          <button
            class="bg-blue-600 px-5 rounded-t-full  rounded-b-full"
            type="button"
            @click="searchTitle"
          >Search</button>
        </div>
      ...
      <h4>
        <b>post List by titles</b>
      </h4>
      <ul class="list-group">
        <li
          v-for="(post, index) in posts"
          :key="index"
          class="list-group-item bg-blue-200 px-5 "
          :class="{ active: index == currentIndex }"
          @click="setActivePost(post, index)"
        >
          <span class="font-bold">{{ post.id }},</span> {{ post.title }}</li>
          </hr>
      </ul>

      <button
        class="bg-blue-500 hover:bg-blue-700 text-white p-2 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
    ...
    <div class="flex flex-wrap">
      ...
      >
        <div class="bg-blue-100 rounded-lg shadow-lg p-5">
          ...
          <button class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">edit post</button>
        </div>
    </div>
  </div>
  </div>
